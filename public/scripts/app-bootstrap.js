(function(document) {
  ...
  window.AppConfig = {"deployEndpoint":"","i18nPath":"locales/","componentsPath":"./bower_components/","composerEndpoint":"./composerMocks/","appId":"","debug":true,"mocks":true,"coreCache":true,"routerLog":false,"cordovaScript":"cordova.js","prplLevel":1,"initialBundle":["staffHome.json"],"transpile":true,"transpileExclude":["cells-rxjs","webcomponentsjs","moment","d3","bgadp*","polymer*"],"urlSRVLocalBack":"http://hackatoons.eu-west-1.elasticbeanstalk.com","urlSRVIntBack":"http://hackatoons.eu-west-1.elasticbeanstalk.com","urlSRVProd1Back":"","urlSRVProd2Back":"","urlSRVLocalFront":"localhost","urlSRVIntFront":"","urlSRVProd1Front":"","urlSRVProd2Front":"","hackServices":{"login":{"url":"https://ei-arqaso.igrupobbva:8050/accounts/v0/contracts-transfer-data","urlMock":"json/mock/createCreditAccount.json","mock":true}},"once":true};
